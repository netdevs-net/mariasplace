...
// load WP Bootstrap Starter styles
    ...
    wp_register_script('jquery.3.4.0', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-migrate/3.4.0/jquery-migrate.min.js');
...
// load bootstrap js
    ...
    wp_enqueue_script('MariasPlace-themejs', get_template_directory_uri() . '/inc/assets/js/theme-script.js', array(), '111', true);
