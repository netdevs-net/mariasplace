...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'MariasPlace' ),
            //'description' => __( 'This is a section for the typography', 'MariasPlace' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'theme_option_setting', array(
        'label' => __( 'Theme Option', 'MariasPlace' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        'label' => __( 'Typography', 'MariasPlace' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Header Banner', 'MariasPlace' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_control(
        'header_img',
        array(
            'label' => __( 'Header Image', 'MariasPlace' ),
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'MariasPlace' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','MariasPlace' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'MariasPlace' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'MariasPlace'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'MariasPlace' ),
            //'description' => __( 'This is a section for the header banner Image.', 'MariasPlace' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'MariasPlace' ),
            //'description' => __( 'This is a section for the header banner Image.', 'MariasPlace' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'MariasPlace' ),
            //'description' => __( 'This is a section for the header banner Image.', 'MariasPlace' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_setting( 'cdn_assets_setting', array(
        'default' => __( 'no','MariasPlace' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 
        'cdn_assets',
        array(
            'label' => __( 'Use CDN for Assets', 'MariasPlace' ),
            'description' => __( 'All Bootstrap Assets and FontAwesome will be loaded in CDN.', 'MariasPlace' ),
            'section' => 'site_name_text_color',
            'settings' => 'cdn_assets_setting',
	        'type'    => 'select',
	        'choices' => array(
	            'yes' => __( 'Yes', 'MariasPlace' ),
	            'no' => __( 'No', 'MariasPlace' ),
        	)
        )
    );
