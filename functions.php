...
//     wp_enqueue_style(
//         'mariasplace-two-column-css',
//         get_template_directory_uri() . '/custom-two-column.css',
//         array(),
...
// /**
//  * Add 2-column CSS directly in head as backup (in case enqueue doesn't work due to caching)
//  */
// function mariasplace_add_two_column_css_inline() {
//     $css_file = get_template_directory() . '/custom-two-column.css';
//     if (file_exists($css_file)) {
//         echo '<style id="mariasplace-two-column-css">' . "\n";
